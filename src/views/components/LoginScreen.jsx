    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-teal-50/20 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-8 md:p-10">
          ...
          <button
            onClick={onLogin}
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-slate-200 rounded-xl font-semibold text-slate-700 hover:border-emerald-400 hover:bg-emerald-50/50 transition-all duration-200 group shadow-sm hover:shadow-md"
          >
            {/* Google Icon SVG */}
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-slate-400">
              Acesso seguro e privado para membros da família
            </p>
          </div>
        </div>
